 ...
 * 功能: 未完成
 */
public class ApplyRepairingAdapter extends BaseQuickAdapter<RepairEntity.PagesBean.ListBean, BaseViewHolder> {

    public ApplyRepairingAdapter(int layoutResId, @Nullable List<RepairEntity.PagesBean.ListBean> data) {
