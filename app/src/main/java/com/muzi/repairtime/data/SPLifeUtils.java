...
class SPLifeUtils {
    ...
    private static final String SP_DATA_NAME = "com.ekwing.launcher";

    private static SharedPreferences getPreferences() {
        return App.getInstance().getApplicationContext().getSharedPreferences(SP_DATA_NAME, Context.MODE_PRIVATE);
    }
